...
**版本現況（2026-09-01 `hdctl list` 實測，取代上面較舊的版本號）：** .191 的 `hd-pacs` 是 **2.0.13+20260825100752**（七支 unit 全 active）、`hd-adminconsole` 是 **0.1.0-alpha.31**。三台主機（.191/.199/.163）的 hdctl 都已升到 **0.2.8**。各台完整安裝清單記在 `docs/environments.md`。
